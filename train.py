...
early_stopping = EarlyStopping(patience=15, delta=0.004)
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 10 == 0:
            torch.save(model.state_dict(), f"stgcn4_epoch{epoch+1}.pth")
    ...
    # save model
    torch.save(model.state_dict(), "stgcn_model4.pth")
    print("Model saved.")
