...
from heuristic.preprocess import AugmentedPennActionDataset
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss - min_delta:
            ...
            counter = 0
            torch.save(model.state_dict(), "heuristic/best_model_heuristic.pth")
            print("Model saved.")
        else:
            counter += 1
    ...
    # ----------------- TESTING ----------------
    model.load_state_dict(torch.load("heuristic/best_model_heuristic.pth"))
    model.eval()
    correct_action = 0
    total_action = 0
